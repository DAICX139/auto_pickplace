...
namespace VisionFlows
{
    public partial class FrmAutoSelect : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            Flow.XmlHelper.SerializeToXml(Utility.Config + "AutoSelect.xml", AutoSelectData.Instance);
        }
        ...
        {
            cmbWorkID.Items.AddRange(Enum.GetNames(typeof(EnumAutoSelect)));
        ...
        {
            AutoSelectPara para = AutoSelectData.Instance.AutoSelectParaList[index];
        ...
        private void UpdatePosiParam(int indexWork, int indexAlgo)
        {
            try
            {
                AutoSelectPara para = AutoSelectData.Instance.AutoSelectParaList[indexWork];
