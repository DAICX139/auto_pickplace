...
{
    [Serializable]
    public class ItemMeasureRect : ItemMeasure2D
    {
        public ItemMeasureRect() : base()
        {
        }

        public ItemMeasureRect(int itemID) : base(ItemType.矩形测量, itemID)
        {
        }
        ...
        [OnSerializing()]
        public void ItemMeasureRectSerializing(StreamingContext context)
        {
        }

        [OnDeserializing()]
        public void ItemMeasureRectDeSerializing(StreamingContext context)
        {
        ...
        [OnDeserialized()]
        public void ItemMeasureRectDeSerialized(StreamingContext context)
        {
