...
{
    [Serializable]
    public class ItemMeasureLine : ItemMeasure2D
    {
        public ItemMeasureLine() : base()
        {
        }

        public ItemMeasureLine(int itemID) : base(ItemType.直线测量, itemID)
        {
        }
        ...
        [OnSerializing()]
        public void ItemMeasureLineSerializing(StreamingContext context)
        {
        }

        [OnDeserializing()]
        public void ItemMeasureLineDeSerializing(StreamingContext context)
        {
        ...
        [OnDeserialized()]
        public void ItemMeasureLineDeSerialized(StreamingContext context)
        {
