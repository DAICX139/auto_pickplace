...
{
    [Serializable]
    public class ItemMeasureCircle : ItemMeasure2D
    {
        public ItemMeasureCircle() : base()
        {
        }

        public ItemMeasureCircle(int itemID) : base(ItemType.圆形测量, itemID)
        {
        }
        ...
        [OnDeserializing()]
        public void ItemMeasureCircleDeSerializing(StreamingContext context)
        {
        ...
        [OnDeserialized()]
        public void ItemMeasureCircleDeSerialized(StreamingContext context)
        {
