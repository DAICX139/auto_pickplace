    ...
    public partial class SuperWind : UserControl
    {
        ...
        public HImage image
        {
            ...
            set
            {
                ...
                {
                    if (viewController==null||roiController == null)
                    {
        ...
        public bool OKNGlable
        {
            set
            {
                ...
                using (HDevDisposeHelper dh = new HDevDisposeHelper())
                {
                    HOperatorSet.DispText(viewController.viewPort.HalconWindow, lable, "window", 10, this.viewController.viewPort.Width - 70,
        ...
        public HObject obj
        {
            set
            {
                if (value != null && value.IsInitialized())
                {
                    ...
                    var mobj = value.CopyObj(1, 100);
                    viewController.viewPort.HalconWindow.DispObj(mobj);
                    mobj.Dispose();
                }
            }
        }
